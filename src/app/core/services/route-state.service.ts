...
export class RouteStateService {
    ...
    private getFromStorage() {
        // let routeStateFromStorage: any = localStorage.getItem("routeState") ? localStorage.getItem("routeState") : "";
        // var routeStates = JSON.parse(routeStateFromStorage);
        // return (routeStates === undefined || routeStates === null) ? [] : routeStates;
        let dummyResponse : any = [];
        let dummyRouteState = new RouteState();
        dummyRouteState.data = "data";
        dummyResponse.push(dummyRouteState);
