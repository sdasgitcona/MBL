...
@Component({
  selector: 'app-cfo-total-payeble-amount-currency-wise-bar',
  templateUrl: './cfo-total-payeble-amount-currency-wise-bar.component.html',
  styleUrls: ['./cfo-total-payeble-amount-currency-wise-bar.component.scss']
})
export class CfoTotalPayebleAmountCurrencyWiseBarComponent implements OnInit {
  ...
  initbarSort() {
    this.httpService.GetById(`/finance-ws/invoice/get-total-payable-amount?subsidiaryIds=` + this.selectedSubsidiaryId, this.selectedSubsidiaryId, this.RetloginDetails.token)
      .subscribe(res => {
        this.chartData = res;
        /* Chart code */
        // Create root element
        // https://www.amcharts.com/docs/v5/getting-started/#Root_element
        let root = am5.Root.new("TotalPayableAmount");
  ...
  toggleFullscreen() {
    let div = document.querySelector('.fullscreenDivTotalPayableAmount');
