...
@Component({
  selector: 'app-cfo-monthly-payment-trend-bar',
  templateUrl: './cfo-monthly-payment-trend-bar.component.html',
  styleUrls: ['./cfo-monthly-payment-trend-bar.component.scss']
})
export class CfoMonthlyPaymentTrendBarComponent implements OnInit {
  ...
  initbarSort() {
    this.httpService.GetById(`/procure-ws/po/draft-total-count?subsidiaryIds=` + this.selectedSubsidiaryId, this.selectedSubsidiaryId, this.RetloginDetails.token)
      .subscribe(res => {
        this.chartData = res;
        /* Chart code */
        // Create root element
        // https://www.amcharts.com/docs/v5/getting-started/#Root_element
        let root = am5.Root.new("MonthlyPaymentTrend");
  ...
  toggleFullscreen() {
    let div = document.querySelector('.fullscreenDivMonthlyPaymentTrend');
