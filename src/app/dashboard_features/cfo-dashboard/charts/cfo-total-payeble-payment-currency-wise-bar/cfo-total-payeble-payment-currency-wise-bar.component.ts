...
@Component({
  selector: 'app-cfo-total-payeble-payment-currency-wise-bar',
  templateUrl: './cfo-total-payeble-payment-currency-wise-bar.component.html',
  styleUrls: ['./cfo-total-payeble-payment-currency-wise-bar.component.scss']
})
export class CfoTotalPayeblePaymentCurrencyWiseBarComponent implements OnInit {
  ...
  initbarSort() {
    this.httpService.GetById(`/finance-ws/payment/get-total-make-payment-currency-wise?subsidiaryIds=` + this.selectedSubsidiaryId, this.selectedSubsidiaryId, this.RetloginDetails.token)
      .subscribe(res => {
        this.chartData = res;
        /* Chart code */
        // Create root element
        // https://www.amcharts.com/docs/v5/getting-started/#Root_element
        let root = am5.Root.new("TotalPayablePaymentCurrency");
  ...
  toggleFullscreen() {
    let div = document.querySelector('.fullscreenDivTotalPayablePaymentCurrency');
