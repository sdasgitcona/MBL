...
@Component({
  selector: 'app-total-having-access-supplier',
  templateUrl: './total-having-access-supplier.component.html',
  styleUrls: ['./total-having-access-supplier.component.scss']
})
export class TotalHavingAccessSupplierComponent implements OnInit {
