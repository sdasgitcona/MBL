...
@Component({
  selector: 'app-recently-created-supplier',
  templateUrl: './recently-created-supplier.component.html',
  styleUrls: ['./recently-created-supplier.component.scss']
})
export class RecentlyCreatedSupplierComponent implements OnInit {
