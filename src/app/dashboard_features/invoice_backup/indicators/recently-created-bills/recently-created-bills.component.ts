...
@Component({
  selector: 'app-recently-created-bills',
  templateUrl: './recently-created-bills.component.html',
  styleUrls: ['./recently-created-bills.component.scss']
})
export class RecentlyCreatedBillsComponent implements OnInit {
