...
@Component({
  selector: 'app-export-to-netsuite',
  templateUrl: './export-to-netsuite.component.html',
  styleUrls: ['./export-to-netsuite.component.scss']
})
export class ExportToNetsuiteComponent implements OnInit {
