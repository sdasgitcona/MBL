...
@Component({
  selector: 'app-recently-created-grn',
  templateUrl: './recently-created-grn.component.html',
  styleUrls: ['./recently-created-grn.component.scss']
})
export class RecentlyCreatedGrnComponent implements OnInit {
  ...
  getApiData(){
    this.httpService
    .GetById('/procure-ws/grn/get-seven-days-old-and-total-count-for-grn?subsidiaryId=' + this.selectedSubsidiaryId, this.selectedSubsidiaryId, this.RetloginDetails.token)
    .subscribe((res) => {
      if (res.status == 401) {
